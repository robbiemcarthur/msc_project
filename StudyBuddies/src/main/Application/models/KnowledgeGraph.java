...
public class KnowledgeGraph implements Digraph {
    ...
    // Each KnowledgeGraph object is a directed graph whose elements and
    // edge attributes are arbitrary objects.

    // This directed graph is represented by a node set and edge set as follows.
    // firstNode is a link to the first node in a DLL of KnowledgeGraph
    // objects, each of which contains an element. firstEdge is a link to the
    // first node in a DLL of KnowledgeGraph objects, each of which
    ...
    public static class Edge implements Graph.Edge {
        ...
        public Edge (KnowledgeGraph.Node source, KnowledgeGraph.Node dest, Object attr) {
            this.source = source;
            this.dest = dest;
            this.attribute = attr;
            this.prevEdge = null;
